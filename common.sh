...
cd ${GITHUB_WORKSPACE}
bash <(curl -fsSL https://raw.githubusercontent.com/shinegod/common/main/custom/first.sh)
}
...
luci-app-smartdns,smartdns,luci-app-wizard,luci-app-msd_lite,msd_lite, \
lua-maxminddb"
t=(${z//,/ })
for x in ${t[@]}; do \
